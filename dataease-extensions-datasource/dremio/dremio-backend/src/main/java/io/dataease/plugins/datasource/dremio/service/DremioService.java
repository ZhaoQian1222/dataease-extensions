package io.dataease.plugins.datasource.dremio.service;
...
@Service
public class DremioService extends DatasourceService {
    ...
    public DataSourceType getDataSourceType() {
        DataSourceType dataSourceType = new DataSourceType("dremio", "Dremio" , true , "", DatasourceCalculationMode.DIRECT, true);
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("dremio-backend");
